...
$sql = "SELECT id, owner,business_name,type,address, contact, type FROM business_permit ";
...
<head>
    ...
    <title>Business Permit List</title>
...
<body>
    ...
    <script>
        ...
        function fetchDetails(id) {
            ...
            xhr.open('GET', 'fetch_permit.php?id=' + id, true);
            xhr.onload = function () {
                if (this.status === 200) {
